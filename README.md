...
Repositorio documental en Markdown dedicado a estudiar, escuchar y recorrer la musica jazz de forma organizada. El proyecto esta pensado como una biblioteca de iniciacion y profundizacion: no solo reune nombres y discos, sino rutas para aprender a oir, comparar estilos, seguir artistas y entender el desarrollo historico del genero.

## Vision del proyecto

JAZZ parte de una idea simple: entrar en el jazz resulta mucho mas facil cuando el aprendizaje se organiza alrededor de preguntas claras.

- de donde viene esta musica
- como suena cada epoca
- que artistas conviene escuchar primero
- que discos ayudan a formar el oido
- como pasar de una cancion aislada a una escucha mas profunda

El objetivo del repositorio no es competir con una enciclopedia, sino ofrecer una puerta de entrada cuidada, ordenada y ampliable.

## Para quien es este repositorio

Este material esta pensado para varios tipos de lector:

- personas que no conocen casi nada de jazz y quieren empezar sin abrumarse
- oyentes que ya tienen algunos discos favoritos pero quieren entender mejor estilos y periodos
- docentes, talleristas o mediadores culturales que necesitan una base clara para clases o recomendaciones
- lectores curiosos que prefieren aprender escuchando albumes, playlists o trayectorias de artistas

No hace falta saber teoria musical para aprovecharlo. Ayuda, claro, pero no es un requisito.

## Como esta organizado

El repositorio se apoya en dos niveles.

### Nivel 1: documentos troncales

- [README.md](./README.md): portada general, mapa del proyecto y rutas de entrada
- [GUIA-JAZZ.md](./GUIA-JAZZ.md): tutorial amplio para empezar con historia, conceptos, artistas y escucha esencial
...
- [BITACORA.md](./BITACORA.md): registro de criterio, avances y proximos pasos
- [CHANGELOG.md](./CHANGELOG.md): historial de cambios del repositorio

## Rutas recomendadas de lectura

No hace falta leer todo en orden lineal. Puedes entrar por la ruta que mas se ajuste a tu manera de aprender.

### Ruta 1: si empiezas desde cero
...
- [Tutorial completo de jazz](./GUIA-JAZZ.md)
...
## Como aprovechar mejor el material

Hay algunas practicas simples que multiplican el valor de estos documentos:

- no intentes memorizarlo todo a la primera
- vuelve varias veces a un mismo artista o disco
- escucha con auriculares y tambien en altavoces si puedes
- compara dos versiones de un mismo standard
- toma notas muy breves de lo que te llama la atencion
- no abandones un estilo dificil demasiado pronto; a veces necesita repeticion

## Enfoque editorial

El proyecto se guia por algunos principios:

- claridad antes que exceso de jerga
- progresion antes que acumulacion desordenada
- escucha antes que puro listado de nombres
- contexto historico sin perder de vista el placer de la musica
- seleccion curada sin fingir que existe una unica lista definitiva
